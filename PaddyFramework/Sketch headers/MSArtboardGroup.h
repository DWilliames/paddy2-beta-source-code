...
- (void)resizeToFitChildren; // SELF ADDED
- (id)parentRoot;
- (id)parentArtboard;
...
@property(retain, nonatomic) MSRulerData *horizontalRulerData;
...
@property(readwrite, nonatomic) BOOL isLayerExportable;
@property(retain, nonatomic) MSLayoutGrid *layout;
@property(copy, nonatomic) NSString *objectID;
@property(readwrite, nonatomic) struct CGPoint origin;
@property(readwrite, nonatomic) struct CGRect rect;
@property(readonly) Class superclass;
@property(retain, nonatomic) MSRulerData *verticalRulerData;
