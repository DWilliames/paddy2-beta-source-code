...
@class MSDocument, MSImmutableDocumentData, NSDictionary, NSString, SMKMirrorController;
...
- (void)sendUpdate;
@property(nonatomic) NSString *currentArtboardID; // @synthesize currentArtboardID=_currentArtboardID;
