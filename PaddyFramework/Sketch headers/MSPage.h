...
@class MSArtboardGroup, MSLayerArray, MSLayoutGrid, MSRulerData, MSSimpleGrid, NSArray, NSMutableSet, NSString;
...
- (struct CGPoint)originForNewArtboardWithSize:(struct CGSize)arg1; // Sketch 49+
