...
#import "MSAssetLibraryControllerDelegate-Protocol.h"
#import "MSCloudDocument-Protocol.h"
...
@property(nonatomic, strong) MSLayerArray *previousSelectedLayers; //
...
- (void)layerSelectionDidChange; // Sketch 50
