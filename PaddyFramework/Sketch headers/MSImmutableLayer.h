...
- (BOOL)enumerateLayersWithOptions:(unsigned long long)arg1 classFilter:(Class)arg2 block:(id)arg3;
...
- (id)containedLayers;
- (void)enumerateImmutableWithOptions:(unsigned long long)arg1 passingTest:(id)arg2 parentCreatorBlock:(id)arg3 inBlock:(id)arg4;
