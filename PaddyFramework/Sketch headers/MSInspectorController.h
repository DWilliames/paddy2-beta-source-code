...
@class MSArtboardInspectorViewController, MSDocument, MSExportInspectorViewController, MSNormalInspector, MSPersistentAssetCollection, MSSliceInspectorViewController, NSLayoutConstraint, NSString, NSView, NSViewController;
...
@property(retain, nonatomic) NSViewController *currentController; // @synthesize currentController=_currentController;
